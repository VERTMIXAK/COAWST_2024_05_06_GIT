...
#file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/SD_2020/data_PHY/GLOBAL_ANALYSIS_FORECAST_PHY_001_024-TDS_2020_002.nc' 
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/SD_2020/data_PHY/GLOBAL_ANALYSIS_FORECAST_PHY_001_024-TDS_2020_001.nc'
dst_dir='./'
...
src_grd_file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/SD_2020/SD_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('SDa_8km_flat')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('SDa_8km_flat', zeta=zeta)
