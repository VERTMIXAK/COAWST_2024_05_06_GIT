...
parentFile = 'GUAMKinner_1km.nc';
childFile = 'GUAMKinnerNest_1km.nc';
contactsFile = 'GUAMKinnerNest_contacts_1km.nc';
...
coarse2fine(parentFile,childFile,5,iCoreLL,iCoreUR,jCoreLL,jCoreUR)
