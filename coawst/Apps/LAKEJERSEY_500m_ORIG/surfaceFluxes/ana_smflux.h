...
!
!! svn $Id: ana_smflux.h 1100 2022-01-06 21:19:26Z arango $
!!======================================================================
...
!
      myTime = time(ng) - 3786825600
!      write(*,*) 'time ',myTime
      DO j=JstrT,JendT
         DO i=IstrP,IendT
           cff1=MIN((0.5_r8*(TANH((myTime/3600.0_r8-ramp_u)/          &
     &                            (ramp_time/6.0_r8))+1.0_r8)),         &
     &              (1.0_r8-(0.5_r8*(TANH((myTime/3600.0_r8-ramp_d)/  &
     &                                    (ramp_time/6.0_r8))+1.0_r8))))
...
!      WRITE (stdout,15) 'jgp begin inside wrt_quick'
!  15  FORMAT(a)
!      WRITE (stdout,20) sustr(10,10)
!  20  FORMAT(f10.4)
! jgp end
