...
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/GUAM_2021/data_PHY/GLOBAL_ANALYSIS_FORECAST_PHY_001_024-TDS_2021_335.nc' 
#file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/GUAM_2021/data_PHY/GLOBAL_ANALYSIS_FORECAST_PHY_001_024-TDS_2021_336.nc'
dst_dir='./'
...
dst_grd = pycnal.grid.get_ROMS_grid('GUAMDinner_1km')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('GUAMDinner_1km', zeta=zeta)
