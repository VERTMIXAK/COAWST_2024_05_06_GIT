...
dstgrd = pycnal.grid.get_ROMS_grid('GUAMDinner_1km')
...
grid2_file = 'remap_grid_GUAMDinner_1km_rho.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_GUAMDinner_1km_bilinear_t_to_rho.nc'
interp_file2 = 'remap_weights_GUAMDinner_1km_to_GLBa0.08_bilinear_rho_to_t.nc'
map1_name = 'GLBa0.08 to GUAMDinner_1km Bilinear Mapping'
map2_name = 'GUAMDinner_1km to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
...
grid2_file = 'remap_grid_GUAMDinner_1km_u.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_GUAMDinner_1km_bilinear_t_to_u.nc'
interp_file2 = 'remap_weights_GUAMDinner_1km_to_GLBa0.08_bilinear_u_to_t.nc'
map1_name = 'GLBa0.08 to GUAMDinner_1km Bilinear Mapping'
map2_name = 'GUAMDinner_1km to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
...
grid2_file = 'remap_grid_GUAMDinner_1km_v.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_GUAMDinner_1km_bilinear_t_to_v.nc'
interp_file2 = 'remap_weights_GUAMDinner_1km_to_GLBa0.08_bilinear_v_to_t.nc'
map1_name = 'GLBa0.08 to GUAMDinner_1km Bilinear Mapping'
map2_name = 'GUAMDinner_1km to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
