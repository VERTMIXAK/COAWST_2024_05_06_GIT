...
for typ in type:
        ...
        grid2_file = 'remap_grid_GUAMDinner_1km_'+str(typ)+'.nc'
        interp_file1 = 'remap_weights_GUAM_Brian_to_GUAMDinner_1km_bilinear_'+str(typ)+'_to_'+str(typ)+'.nc'
        interp_file2 = 'remap_weights_GUAMDinner_1km_to_GUAM_Brian_bilinear_'+str(typ)+'_to_'+str(typ)+'.nc'
        map1_name = 'GUAM_Brian to GUAMDinner_1km Bilinear Mapping'
        map2_name = 'GUAMDinner_1km to GUAM_Brian Bilinear Mapping'
        num_maps = 1
        map_method = 'bilinear'
