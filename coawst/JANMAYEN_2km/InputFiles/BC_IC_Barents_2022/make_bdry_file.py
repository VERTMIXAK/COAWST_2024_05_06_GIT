...
data_dir = '/import/c1/VERTMIX/jgpender/ROMS/Barents/NORSE_2022_SA/data_Barents/'
...
src_grd_file = data_dir + '../Barents_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('JANMAYEN_2km')
...
for file in lst_file:
    ...
    dst_grd = pycnal.grid.get_ROMS_grid('JANMAYEN_2km', zeta=zeta)
