...
#file = '/import/c1/VERTMIX/jgpender/ROMS/UH_archived/GUAM_2022_largeArea/data/UH_2022-01-01.nc'
file = 'UH_074_flat.nc'
dst_dir='./'
...
src_grd_file = '/import/c1/VERTMIX/jgpender/ROMS/UH_archived/GUAM_2022_largeArea/GUAM_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('GUAMJinner_1km_edgeSmoothing')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('GUAMJinner_1km_edgeSmoothing', zeta=zeta)
