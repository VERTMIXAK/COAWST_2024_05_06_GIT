...
data_dir = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS_motu/NorthSea_2020/data_PHY/'

dst_dir='./'

myArg = 'ls ' + data_dir + 'GLOBAL*.nc'
#print('myArg = ',myArg)
...
src_grd_file = data_dir + '../NorthSea_grid.nc'
