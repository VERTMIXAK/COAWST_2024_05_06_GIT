...
romsDir  = 'NORSE1D_5km_freyaCast_1015__deadStill__LMD/'
gridFile = [romsDir,'NORSE1D_5km.nc'];
HISFile  = [romsDir,'netcdfOutput/norse_his_00001.nc'];
ICFile   = [romsDir,'IC.nc'];

grd = roms_get_grid(gridFile,HISFile,0,1);
grdIC = roms_get_grid(gridFile,ICFile,0,1);
