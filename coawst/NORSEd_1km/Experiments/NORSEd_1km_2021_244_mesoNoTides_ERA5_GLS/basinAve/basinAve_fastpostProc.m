...
fig(1);plot(sfos.time,sfos.Temp_BasinAve);title('Basin-average temperature');xlabel('date -   2021')
datetick('x','mm/dd','keepticks')
print('figures/Temp_BasinAve','-djpeg');

fig(2);plot(sfos.time,sfos.Salt_BasinAve);title('Basin-average salinity');xlabel('date -   2021')
datetick('x','mm/dd','keepticks')
print('figures/Salt_BasinAve','-djpeg');

fig(3);plot(sfos.time,sfos.SSH_BasinAve);title('Basin-average zeta');xlabel('date -   2021')
datetick('x','mm/dd','keepticks')
print('figures/SSH_BasinAve' ,'-djpeg');

fig(4);plot(sfos.time,sfos.SST_BasinAve);title('Basin-average surface temperature');xlabel('date -   2021')
datetick('x','mm/dd','keepticks')
print('figures/SST_BasinAve' ,'-djpeg');

fig(5);plot(sfos.time,sfos.SSS_BasinAve);title('Basin-average surface salinity');xlabel('date -   2021')
datetick('x','mm/dd','keepticks')
print('figures/SSS_BasinAve' ,'-djpeg');



fig(6);plot(sfos.time,sfos.shflux_BasinAve);title('Basin-average shflux');xlabel('date -   2021')
datetick('x','mm/dd','keepticks')
print('figures/shflux_BasinAve' ,'-djpeg');

fig(7);plot(sfos.time,sfos.ssflux_BasinAve);title('Basin-average ssflux');xlabel('date -   2021')
datetick('x','mm/dd','keepticks')
print('figures/ssflux_BasinAve' ,'-djpeg');

fig(8);plot(sfos.time,sfos.swrad_BasinAve);title('Basin-average swrad');xlabel('date -   2021')
datetick('x','mm/dd','keepticks')
print('figures/swrad_BasinAve' ,'-djpeg');

fig(9);plot(sfos.time,sfos.sustr_BasinAve);title('Basin-average sustr');xlabel('date -   2021')
datetick('x','mm/dd','keepticks')
print('figures/sustr_BasinAve' ,'-djpeg');

fig(10);plot(sfos.time,sfos.svstr_BasinAve);title('Basin-average svstr');xlabel('date -   2021')
datetick('x','mm/dd','keepticks')
