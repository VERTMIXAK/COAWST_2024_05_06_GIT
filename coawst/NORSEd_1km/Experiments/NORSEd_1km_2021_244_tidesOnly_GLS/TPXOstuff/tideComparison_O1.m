...
%     tpxo.pha_vbar_BB = interp2(tpxo.lon(tpxo.idxs),tpxo.lat(tpxo.jdxs),tpxo.pha_vbar(tpxo.jdxs,tpxo.idxs),model.lon,model.lat);
    ...
    model.lon_rho = grid.lon_rho(1:hskip:end,1:hskip:end);  model.lon_rho = model.lon_rho + 360;
    model.lon_u   = grid.lon_u(1:hskip:end,1:hskip:end);    model.lon_u   = model.lon_u   + 360;
    model.lon_v   = grid.lon_v(1:hskip:end,1:hskip:end);    model.lon_v   = model.lon_v   + 360;
