...
fileIn  = 'DOPPIO_2020_bdry_NGnest_100m_parent.nc';
fileOut = 'DOPPIO_2020_bdry_NGnest_100m_parent_detided.nc_hourly';
fileOutShort = 'DOPPIO_2020_bdry_NGnest_100m_parent_detided.nc';
...
% Make a smaller version of the detided file

unix(['ncks -O -d ocean_time,0,',num2str(length(times)-1),',12 ',fileOut,' ',fileOutShort]);
done('make new file')
...
dat_ORIG = z_west_ORIG(1:240,20);
dat_smoo = z_west_smoo(1:240,20);
