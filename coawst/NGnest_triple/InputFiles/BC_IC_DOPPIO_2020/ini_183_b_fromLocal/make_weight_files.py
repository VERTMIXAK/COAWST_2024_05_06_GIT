...
dstgrd = pycnal.grid.get_ROMS_grid('NGnest_triple_b')
...
for typ in type:
        ...
        grid2_file = 'remap_grid_NGnest_triple_b_'+str(typ)+'.nc'
        interp_file1 = 'remap_weights_NGnest_triple_b_to_NGnest_triple_b_bilinear_'+str(typ)+'_to_'+str(typ)+'.nc'
        interp_file2 = 'remap_weights_NGnest_triple_b_to_NGnest_triple_b_bilinear_'+str(typ)+'_to_'+str(typ)+'.nc'
        map1_name = 'NGnest_triple_b to NGnest_triple_b Bilinear Mapping'
        map2_name = 'NGnest_triple_b to NGnest_triple_b Bilinear Mapping'
        num_maps = 1
        map_method = 'bilinear'
