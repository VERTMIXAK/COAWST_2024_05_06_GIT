...
src_filename = 'IC_b_subset.nc'
wts_file = "./remap_weights_NGnest_triple_b_subset_to_NGnest_triple_c_bilinear_*"
src_grd = pycnal.grid.get_ROMS_grid('NGnest_triple_b_subset')
