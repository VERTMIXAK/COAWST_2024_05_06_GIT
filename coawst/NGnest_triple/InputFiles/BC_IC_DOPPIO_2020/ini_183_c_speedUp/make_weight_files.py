...
srcgrd = pycnal.grid.get_ROMS_grid('NGnest_triple_b_subset')
...
for typ in type:
    for tip in type:
        grid1_file = 'remap_grid_NGnest_triple_b_subset_'+str(typ)+'.nc'
        grid2_file = 'remap_grid_NGnest_triple_c_'+str(tip)+'.nc'
        interp_file1 = 'remap_weights_NGnest_triple_b_subset_to_NGnest_triple_c_bilinear_'+str(typ)+'_to_'+str(tip)+'.nc'
        interp_file2 = 'remap_weights_NGnest_triple_c_to_NGnest_triple_b_subset_bilinear_'+str(tip)+'_to_'+str(typ)+'.nc'
        map1_name = 'NGnest_triple_b_subset to NGnest_triple_c Bilinear Mapping'
        map2_name = 'NGnest_triple_c to NGnest_triple_b_subset Bilinear Mapping'
        num_maps = 1
        map_method = 'bilinear'
