...
data_dir = '/import/c1/VERTMIX/jgpender/ROMS/DOPPIO/DOPPIO_2020/data_DOPPIO_clean/'

dst_dir='./'

myArg = 'ls ' + data_dir + 'DOPPIO*0_*'
print('myArg = ',myArg)
...
wts_file = "./ini_183_parent/remap_weights_DOPPIO_to_NGnest_100m_parent_bilinear_*"
src_grd = pycnal.grid.get_ROMS_grid('DOPPIO')
dst_grd = pycnal.grid.get_ROMS_grid('NGnest_100m_parent')
...
for file in lst_file:
    ...
    outName = nameStart + '_NGnest_100m_parent_bdry.nc'
