...
## !!!! do yesterday for now
##myDate=`date +"%Y-%m-%d"`
#myDate=`date --date="yesterday" +"%Y-%m-%d"`
#grep $myDate /import/VERTMIXFS/jgpender/roms-kate_svn/addl_Scripts/dayConverterCommas.txt > dates.txt
...
# downloads are done. now do field names and times

bash ./fixNamesTimes.bash
