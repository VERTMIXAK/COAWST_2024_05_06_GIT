oldFile = 'Flat_bdry_GUAMFinner_1km_seamount2.nc';
newFile = 'TidalPulse_seamount2.nc';
...
for tt = ttStart:ttStart+24
    ubar(tt,:) = pulse(tt-ttStart+1);
    u(tt,:,:)  = pulse(tt-ttStart+1);
end;
