...
nc_data = netCDF.Dataset('runoff_1980_1981a.nc', 'r')
runoff_file =       'NGOA_runoff_1980_1981.nc'
#nc_data = netCDF.Dataset('runoff_2014a.nc', 'r')
#runoff_file =       'NGOA_runoff_2014.nc'
...
wts_file = 'remap_weights_runoff_to_SEAKp_1km_conservative_nomask.nc'
nt = data.shape[0]
...
# create runoff file
#runoff_file = 'runoff_SEAKp_1km_daitren_inter_annual_2002-2004.nc'
