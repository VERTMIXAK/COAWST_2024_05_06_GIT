...
sourceData = ['/import/c1/VERTMIX/jgpender/roms-kate_svn/GlobalDataFiles/JRA_SEAK/JRA55DO_1.4_Tair_',year,'_SEAK_monthlyAve.nc'];

tair = nc_varget(sourceData,'Tair') - 272.15;
lat  = nc_varget(sourceData,'lat');
lon  = nc_varget(sourceData,'lon');

riverFileORIG = ['JRA-1.4_SEAKp_rivers_',year,'.nc_ORIG'];
riverFile  = ['JRA-1.4_SEAKp_rivers_',year,'.nc'];
