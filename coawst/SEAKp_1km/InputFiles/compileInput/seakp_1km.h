...
# undef LMD_MIXING    /* jgp undef LMD */
# ifdef LMD_MIXING
#  define LMD_RIMIX
#  define LMD_CONVEC
#  define LMD_SKPP
...
# define GLS_MIXING     /* jgp define GLS */
# undef MY25_MIXING
...
/* jgp using the 'other' runoff scheme controled by ocean.in file. The river forcing file
assume no vertical variation in temperature and salinity, so define this flag: */

/* This was deffed in the ROMS-only workspace, but is not successfully compiling here. Undef
this parameter and modify the river forcing file accordingly.
