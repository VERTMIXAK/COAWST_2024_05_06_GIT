...
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/SEAK_2017/data_PHY/CMEMS_PHY_2017_004.nc'
dst_dir='./'
...
src_grd_file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/SEAK_2017/CMEMS_SEAK_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('SEAKp_1km')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('SEAKp_1km', zeta=zeta)
