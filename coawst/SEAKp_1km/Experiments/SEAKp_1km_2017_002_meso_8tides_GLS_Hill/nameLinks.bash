...
# ROMS may not be done with the last link, so get rid of it just in case


dum=`ls netcdfOutput_nameLinks/bob_his_201* | tail -1`
dum2=`ls netcdfOutput_nameLinks/bob_his2_201* | tail -1`
