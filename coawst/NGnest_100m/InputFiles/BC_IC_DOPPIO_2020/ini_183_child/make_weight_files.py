...
dstgrd = pycnal.grid.get_ROMS_grid('NGnest_100m_child_new')
...
for typ in type:
    for tip in type:
        ...
        grid2_file = 'remap_grid_NGnest_100m_child_new_'+str(tip)+'.nc'
        interp_file1 = 'remap_weights_DOPPIO_to_NGnest_100m_child_new_bilinear_'+str(typ)+'_to_'+str(tip)+'.nc'
        interp_file2 = 'remap_weights_NGnest_100m_child_new_to_DOPPIO_bilinear_'+str(tip)+'_to_'+str(typ)+'.nc'
        map1_name = 'DOPPIO to NGnest_100m_child_new Bilinear Mapping'
        map2_name = 'NGnest_100m_child_new to DOPPIO Bilinear Mapping'
        num_maps = 1
        map_method = 'bilinear'
