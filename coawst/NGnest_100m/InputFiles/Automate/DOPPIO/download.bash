...
part2a='&var=mask_psi&var=mask_u&var=mask_v'
part2b='&var=shflux&var=ssflux&var=sustr&var=svstr&var=AKs&var=AKt&var=AKv'
...
do
	...
	site=$part1$file$part2$part2a$part3$timeStamp1$part4$timeStamp2$part5
