...
names3 = {'Pair', 'lwrad_down', 'swrad_up', 'swrad_down','Qair', 'Tair', 'Uwind', 'Vwind'};
times3 = {'pair_time', 'lrf_time', 'srf_time', 'srf_time', 'qair_time', 'tair_time', 'wind_time', 'wind_time'};
