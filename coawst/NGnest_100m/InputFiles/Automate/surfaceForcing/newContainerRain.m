...
names3 = {'Pair',  'rain', 'lwrad_down', 'swradDown', 'swradUp', 'cloud', 'albedo'};
times3 = {'pair_time', 'rain_time', 'lrf_time', 'srf_time', 'srf_time', 'cloud_time', 'albedo_time'};

names4 = {'Qair', 'Tair', 'Uwind', 'Vwind'};
times4 = { 'qair_time', 'tair_time', 'wind_time', 'wind_time'};

long3  = {'Pressure at 2m','rain at surface','downward longwave radiation at surface','downward shortwave radiation at surface','upward shortwave radiation at surface','total cloud cover','albedo at ground'};
long4  = {'Specific Humidity at 2m','Temperature at 2m','u component of wind at 10m','v component of wind at 10m'};

units3 = {'Percent','Pa','kg m-2 s-1','W m-2','W m-2',' ',' '};
