...
for typ in type:
    for tip in type:
        ...
        interp_file1 = 'remap_weights_DOPPIO_reduced_to_NGnest_100m_parent_bilinear_'+str(typ)+'_to_'+str(tip)+'.nc'
        interp_file2 = 'remap_weights_NGnest_100m_parent_to_DOPPIO_reduced_bilinear_'+str(tip)+'_to_'+str(typ)+'.nc'
        map1_name = 'DOPPIO_reduced to NGnest_100m_parent Bilinear Mapping'
        map2_name = 'NGnest_100m_parent to DOPPIO_reduced Bilinear Mapping'
        num_maps = 1
        map_method = 'bilinear'
