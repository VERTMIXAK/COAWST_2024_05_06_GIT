...
tStart=`date --date="2022-03-12" "+%Y-%m-%d"`
echo $tStart
tEnd=`date --date="2022-04-18" "+%Y-%m-%d"`
echo $tEnd

source ~/.runROMSintel


part1='http://pae-paha.pacioos.hawaii.edu/thredds/ncss/wrf_cnmi/WRF_CNMI_Regional_Atmospheric_Model_best.ncd?var=Pair&var='
