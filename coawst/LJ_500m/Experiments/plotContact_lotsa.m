...
fig(10);clf;
pcolor(lonAu,latAu,myUa);colorbar
...
plot(myUa(20,:),'.')
title(['u on A grid, nz = ',num2str(myZ),'  ny = 20','  nt = ',num2str(myTa)])

fig(12);clf;
plot(myUb(20,:));hold on
plot(myUb(20,:),'.')
title(['u on B grid, nz = ',num2str(myZ),'  ny = 20','  nt = ',num2str(myTb)])

fig(51);clf;
pcolorjw(lonAu,latAu,myUa);colorbar;shading faceted
xlim([lonminU-delta lonminU+delta]);ylim([latminU-delta latminU+delta]);
caxis(myLim*[-1 1]);
title(['u on A grid with u on B grid overlay, nz = ',num2str(myZ),'  ntA = ',num2str(myTa),'  ntB = ',num2str(myTb)])
hold on
pcolorjw(lonBu,latBu,myUb);shading faceted

fig(52);clf;
pcolorjw(lonAu,latAu,myUa);colorbar;shading faceted
xlim([lonminU-delta lonminU+delta]);ylim([latmaxU-delta latmaxU+delta]);
caxis(myLim*[-1 1]);
title(['u on A grid with u on B grid overlay, nz = ',num2str(myZ),'  ntA = ',num2str(myTa),'  ntB = ',num2str(myTb)])
hold on
pcolorjw(lonBu,latBu,myUb);shading faceted
...
fig(53);clf;
pcolorjw(lonAu,latAu,myUa);colorbar;shading faceted
xlim([lonmaxU-delta lonmaxU+delta]);ylim([latminU-delta latminU+delta]);
caxis(myLim*[-1 1]);
title(['u on A grid with u on B grid overlay, nz = ',num2str(myZ),'  ntA = ',num2str(myTa),'  ntB = ',num2str(myTb)])
hold on
pcolorjw(lonBu,latBu,myUb);shading faceted
...
fig(54);clf;
pcolorjw(lonAu,latAu,myUa);colorbar;shading faceted
xlim([lonmaxU-delta lonmaxU+delta]);ylim([latmaxU-delta latmaxU+delta]);
caxis(myLim*[-1 1]);
title(['u on A grid with u on B grid overlay, nz = ',num2str(myZ),'  ntA = ',num2str(myTa),'  ntB = ',num2str(myTb)])
hold on
pcolorjw(lonBu,latBu,myUb);shading faceted
...
% fig(12);clf;
% pcolor(lonBu,latBu,myUb);colorbar
% caxis(myLim*[-1 1]);
...
fig(61);clf;
pcolor(lonAv,latAv,myVa);colorbar
xlim([lonminV-delta lonminV+delta]);ylim([latminV-delta latminV+delta]);
caxis(myLim*[-1 1]);
title(['v on A grid with v on B grid overlay, nz = ',num2str(myZ),'  ntA = ',num2str(myTa),'  ntB = ',num2str(myTb)])
hold on
pcolor(lonBv,latBv,myVb)

fig(62);clf;
pcolor(lonAv,latAv,myVa);colorbar
xlim([lonminV-delta lonminV+delta]);ylim([latmaxV-delta latmaxV+delta]);
caxis(myLim*[-1 1]);
title(['v on A grid with v on B grid overlay, nz = ',num2str(myZ),'  ntA = ',num2str(myTa),'  ntB = ',num2str(myTb)])
hold on
pcolor(lonBv,latBv,myVb)
...
fig(63);clf;
pcolor(lonAv,latAv,myVa);colorbar
xlim([lonmaxV-delta lonmaxV+delta]);ylim([latminV-delta latminV+delta]);
caxis(myLim*[-1 1]);
title(['v on A grid with v on B grid overlay, nz = ',num2str(myZ),'  ntA = ',num2str(myTa),'  ntB = ',num2str(myTb)])
hold on
pcolor(lonBv,latBv,myVb)
...
fig(64);clf;
pcolor(lonAv,latAv,myVa);colorbar
xlim([lonmaxV-delta lonmaxV+delta]);ylim([latmaxV-delta latmaxV+delta]);
caxis(myLim*[-1 1]);
title(['v on A grid with v on B grid overlay, nz = ',num2str(myZ),'  ntA = ',num2str(myTa),'  ntB = ',num2str(myTb)])
hold on
pcolor(lonBv,latBv,myVb)
