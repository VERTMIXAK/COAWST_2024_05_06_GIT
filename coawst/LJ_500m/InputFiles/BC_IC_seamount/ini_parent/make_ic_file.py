...
file = '../../createSourceFile/CMEMSsource_2021_244.nc'
dst_dir='./'
...
src_grd_file = '../../createSourceFile/LARRY_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('LJ_500m_parent')

# remap
print('about to do zeta')
print('source file is ',file)
print('src_grd is ',src_grd)
print('dst_grd is ',dst_grd)

zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('LJ_500m_parent', zeta=zeta)
