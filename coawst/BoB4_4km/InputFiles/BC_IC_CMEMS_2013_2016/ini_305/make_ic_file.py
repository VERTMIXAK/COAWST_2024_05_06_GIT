...
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/BoB_2013/data/CMEMS_2013_304.nc'
dst_dir='./'
...
src_grd_file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/BoB_2013/CMEMS_BoB_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('BoB4_4km')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('BoB4_4km', zeta=zeta)
