...
sxi.long_name = 'river XI-position at RHO-points'
xi.valid_min = 1
xi.valid_max = 361    # WARNING - hardcoded Lm+1

eta = out.createVariable('river_Eposition', 'i4', ('river'))
eta.long_name = 'river ETA-position at RHO-points'
eta.valid_min = 1
eta.valid_max = 221    # WARNING - hardcoded Mm+1
