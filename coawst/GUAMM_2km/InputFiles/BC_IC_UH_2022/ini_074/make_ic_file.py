...
file = '/import/c1/VERTMIX/jgpender/ROMS/Brian/GUAM_2km/dataDir/GUAM_2022-03-15_0.nc'
dst_dir='./'
...
src_grd_file = '/import/c1/VERTMIX/jgpender/ROMS/Brian/GUAM_2km/GUAM_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('GUAMM_2km')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('GUAMM_2km', zeta=zeta)
