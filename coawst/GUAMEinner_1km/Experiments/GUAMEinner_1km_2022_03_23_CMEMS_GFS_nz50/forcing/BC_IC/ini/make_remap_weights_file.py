...
dstgrd = pycnal.grid.get_ROMS_grid('GUAMEinner_1km50')
...
grid2_file = 'remap_grid_GUAMEinner_1km50_rho.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_GUAMEinner_1km50_bilinear_t_to_rho.nc'
interp_file2 = 'remap_weights_GUAMEinner_1km50_to_GLBa0.08_bilinear_rho_to_t.nc'
map1_name = 'GLBa0.08 to GUAMEinner_1km50 Bilinear Mapping'
map2_name = 'GUAMEinner_1km50 to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
...
grid2_file = 'remap_grid_GUAMEinner_1km50_u.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_GUAMEinner_1km50_bilinear_t_to_u.nc'
interp_file2 = 'remap_weights_GUAMEinner_1km50_to_GLBa0.08_bilinear_u_to_t.nc'
map1_name = 'GLBa0.08 to GUAMEinner_1km50 Bilinear Mapping'
map2_name = 'GUAMEinner_1km50 to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
...
grid2_file = 'remap_grid_GUAMEinner_1km50_v.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_GUAMEinner_1km50_bilinear_t_to_v.nc'
interp_file2 = 'remap_weights_GUAMEinner_1km50_to_GLBa0.08_bilinear_v_to_t.nc'
map1_name = 'GLBa0.08 to GUAMEinner_1km50 Bilinear Mapping'
map2_name = 'GUAMEinner_1km50 to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
