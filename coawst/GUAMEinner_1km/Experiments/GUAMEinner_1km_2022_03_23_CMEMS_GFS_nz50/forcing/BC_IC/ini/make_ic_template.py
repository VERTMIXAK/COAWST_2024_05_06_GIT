...
file = "/import/c1/VERTMIX/jgpender/ROMS/CMEMS/GUAM_2022/data_PHY/GLOBAL_ANALYSIS_FORECAST_PHY_001_024-TDS_2022_XXX.nc"
dst_dir='./'
...
dst_grd = pycnal.grid.get_ROMS_grid('GUAMEinner_1km50')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('GUAMEinner_1km50', zeta=zeta)
