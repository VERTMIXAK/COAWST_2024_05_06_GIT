gridFile = 'GUAMIinner_1km_seamount.nc';
...
% dum.Name = 'visc_factor'; dum.Nctype = 'float'; dum.Dimension =
% {'eta_rho','xi_rho'}; dum.Attribute =
% struct('Name',{'long_name','units','coordinates','field'},'Value',{'linear
% bottom drag coefficient','m/s','eta_rho xi_rho','visc_factor, scalar,
% series'}); nc_addvar(gridFile,dum);
% 
% dum.Name = 'diff_factor'; dum.Nctype = 'float'; dum.Dimension =
% {'eta_rho','xi_rho'}; dum.Attribute =
% struct('Name',{'long_name','units','coordinates','field'},'Value',{'diffusion
% spatial scaling factor','m/s','eta_rho xi_rho','diff_factor, scalar,
% series'}); nc_addvar(gridFile,dum);
