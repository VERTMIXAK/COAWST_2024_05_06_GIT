...
part3='&disableLLSubset=on&disableProjSubset=on&horizStride=1&time='
part4='&vertCoord=&addLatLon=true&accept=netcdf'
...
do
    ...
    timeStamp1=$date'T00:00:00Z'
	timeStamp2=$date'T00%3A00%3A00Z'

#    site=$part1$timeStamp1$part2a$part3$timeStamp2$part4
	site=$part1$timeStamp1$part2a$part3$timeStamp2
	echo $site
...
#    site=$part1$timeStamp1$part2b$part3$timeStamp2$part4
    site=$part1$timeStamp1$part2b$part3$timeStamp2
    echo $site
    wget --load-cookies ~/.urs_cookies --save-cookies ~/.urs_cookies --auth-no-challenge=on --keep-session-cookies --content-disposition $site
