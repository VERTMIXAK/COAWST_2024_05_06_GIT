...
if [[ $Ngrids -eq 1 ]];then
	runDays=` echo "scale=2; $ntimes * $dt / 86400 " | bc`
	...
	do
		...
		runDays=` echo "scale=2; $ntimesDum * $dtDum / 86400 " | bc`
...
viscCalc=`echo "scale=1;  $hypotenuse  / 100. " | bc`
