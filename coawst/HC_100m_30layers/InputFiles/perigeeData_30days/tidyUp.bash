...
# convert the timestamps to days since 1900
	...
	for myFile in `ls HIS*`
	do
		echo $myFile
        ncatted -O -a units,ocean_time,o,c,"days since 1900-01-01 00:00:00" $myFile
	done
    ...
    do	
      	echo $myFile
        python settime.py $myFile ocean_time
    done
...
#   Make the river forcing file
    ...
    echo "starting river"
    cd $baseDir/InputFiles/Runoff_30days
    \rm river*
    mv $baseDir/InputFiles/perigeeData_30days/rivers.nc riversLO.nc
    pwd
    ls
