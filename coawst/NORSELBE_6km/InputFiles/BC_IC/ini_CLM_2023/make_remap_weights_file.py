...
dstgrd = pycnal.grid.get_ROMS_grid('NORSELBE_6km')
...
grid2_file = 'remap_grid_NORSELBE_6km_rho.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_NORSELBE_6km_bilinear_t_to_rho.nc'
interp_file2 = 'remap_weights_NORSELBE_6km_to_GLBa0.08_bilinear_rho_to_t.nc'
map1_name = 'GLBa0.08 to NORSELBE_6km Bilinear Mapping'
map2_name = 'NORSELBE_6km to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
...
grid2_file = 'remap_grid_NORSELBE_6km_u.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_NORSELBE_6km_bilinear_t_to_u.nc'
interp_file2 = 'remap_weights_NORSELBE_6km_to_GLBa0.08_bilinear_u_to_t.nc'
map1_name = 'GLBa0.08 to NORSELBE_6km Bilinear Mapping'
map2_name = 'NORSELBE_6km to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
...
grid2_file = 'remap_grid_NORSELBE_6km_v.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_NORSELBE_6km_bilinear_t_to_v.nc'
interp_file2 = 'remap_weights_NORSELBE_6km_to_GLBa0.08_bilinear_v_to_t.nc'
map1_name = 'GLBa0.08 to NORSELBE_6km Bilinear Mapping'
map2_name = 'NORSELBE_6km to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
