...
#file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/PALAU_2022/data_PHY/GLOBAL_ANALYSIS_FORECAST_PHY_001_024-TDS_2022_014.nc'
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/PALAU_2022/data_PHY/GLOBAL_ANALYSIS_FORECAST_PHY_001_024-TDS_2022_013.nc'
#file = 'CMEMSsource_014_flat.nc'
dst_dir='./'
...
src_grd_file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/PALAU_2022/PALAU_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('PALAU_600m')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('PALAU_600m', zeta=zeta)
