...
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/SD_2020/data_PHY/GLOBAL_ANALYSIS_FORECAST_PHY_001_024-TDS_2020_366.nc' 
...
dst_grd = pycnal.grid.get_ROMS_grid('SDc_8km')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('SDc_8km', zeta=zeta)
