...
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/NORSE_2020/data_PHY/CMEMS_PHY_2020_244.nc'
#file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/NORSE_2020/data_PHY/CMEMS_PHY_2020_245.nc'
dst_dir='./'
...
src_grd_file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/NORSE_2020/CMEMS_NORSE_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('NORSEa_2km')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('NORSEa_2km', zeta=zeta)
