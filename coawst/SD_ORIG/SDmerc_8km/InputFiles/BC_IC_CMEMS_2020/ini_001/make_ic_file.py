...
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/SD_2020/data_PHY/CMEMS_PHY_2019_365.nc' 
#file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/SD_2020/data_PHY/CMEMS_PHY_2020_001.nc'
dst_dir='./'
...
src_grd_file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/SD_2020/CMEMS_SD_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('SDmerc_8km')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('SDmerc_8km', zeta=zeta)
