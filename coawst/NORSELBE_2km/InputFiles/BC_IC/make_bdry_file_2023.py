...
data_dir = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS_CLI/NORSE_ICBC_2021-2023/data/'

dst_dir='./'

myArg = 'ls ' + data_dir + 'C*2023*.nc'
#print('myArg = ',myArg)
...
src_grd_file = data_dir + '../NORSE_grid.nc'
