...
#file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS_CLI/NORSE_ICBC_2021-2023/data/CMEMS_2021-/import/c1/VERTMIX/jgpender/ROMS/CMEMS_CLI/NORSE_ICBC_2021-2023/data/CMEMS_2023-12-09.nc.nc'
file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS_CLI/NORSE_ICBC_2021-2023/data/CMEMS_2023-12-09.nc'
dst_dir='./'
...
dst_grd = pycnal.grid.get_ROMS_grid('NORSELBE_2km')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('NORSELBE_2km', zeta=zeta)
