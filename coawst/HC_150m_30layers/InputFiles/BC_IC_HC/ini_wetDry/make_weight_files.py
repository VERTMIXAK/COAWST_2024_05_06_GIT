...
dstgrd = pycnal.grid.get_ROMS_grid('HC_150mMEWetDry')
...
for typ in type:
        ...
        grid2_file = 'remap_grid_HC_150mMEWetDry_'+str(typ)+'.nc'
        interp_file1 = 'remap_weights_CAS6_to_HC_150mMEWetDry_bilinear_'+str(typ)+'_to_'+str(typ)+'.nc'
        interp_file2 = 'remap_weights_HC_150mMEWetDry_to_CAS6_bilinear_'+str(typ)+'_to_'+str(typ)+'.nc'
        map1_name = 'CAS6 to HC_150mMEWetDry Bilinear Mapping'
        map2_name = 'HC_150mMEWetDry to CAS6 Bilinear Mapping'
        num_maps = 1
        map_method = 'bilinear'
