...
wts_file = "ini_wetDry_356/remap_weights_CAS6_to_HC_150mMEWetDry_bilinear_*"
src_grd = pycnal.grid.get_ROMS_grid('CAS6')
dst_grd = pycnal.grid.get_ROMS_grid('HC_150mMEWetDry')
...
myArg = 'ls  ' + 'HIS.nc'
myArg = 'ls /import/c1/VERTMIX/jgpender/coawst/HC_100m_30layers/InputFiles/perigeeBulkData/scheduleForDeletion/HIS*.nc'
print('myArg = ', myArg)
