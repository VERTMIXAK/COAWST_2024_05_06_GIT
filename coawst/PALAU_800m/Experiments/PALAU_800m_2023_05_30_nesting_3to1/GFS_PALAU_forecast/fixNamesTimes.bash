...
/usr/bin/ncatted -O -a units,Tair,o,c,"C"     	GFS_Tair_$year.nc_ORIG
/usr/bin/ncatted -O -a valid_range,Tair,d,,    	GFS_Tair_$year.nc_ORIG
...
do
    ...
    /usr/bin/ncatted -O -a units,$time,o,c,"days since 1900-01-01 00:00:00" $file
	...
	then
		...
		/usr/bin/ncatted -O -a units,albedo,o,c,' ' $file
	fi

    if [ $name == 'cloud' ]
    then
        echo "doing cloud now"
        /usr/bin/ncatted -O -a units,cloud,o,c,' ' $file
    fi	
