...
#file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/PALAU_2022/data_PHY/GLOBAL_ANALYSIS_FORECAST_PHY_001_024-TDS_2022_001.nc'
#file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/PALAU_2022/data_PHY/GLOBAL_ANALYSIS_FORECAST_PHY_001_024-TDS_2022_002.nc'
...
print('file ', file)
print('src_grd ',src_grd)
print('dst_grd ',dst_grd)
print('dst_dir ',dst_dir)


zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('PALAU_8km', zeta=zeta)
