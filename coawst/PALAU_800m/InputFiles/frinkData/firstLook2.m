...
% fileUHfilt = 'bry/palau_bry_08049_detide.nc';
fileUH     = 'bry_new/palau_bry_08049_detide.nc';
fileUHfilt = 'bry_new/palau_bry_08049_D.nc';

timesUHfilt = nc_varget(fileUHfilt,'bry_time');
...
plot(timesUH,datUHfilt,'r');
xlabel('time (hour)')
ylabel('amplitude (m/s)')

fig(99);clf;
plot(timesUH,datUH-datUHfilt)
