...
model.gfile = 'grid_BrianFull.nc';
model.HISfile = '../his_08049/fleat_his_08049.nc';
...
%     tpxo.pha_vbar_BB = interp2(tpxo.lon(tpxo.idxs),tpxo.lat(tpxo.jdxs),tpxo.pha_vbar(tpxo.jdxs,tpxo.idxs),model.lon,model.lat);
    ...
    zeta = nc_varget(['./',model.file_prefix,'zeta_49_79.nc'],'zeta');
    ...
    ubar = nc_varget(['./',model.file_prefix,'ubar_49_79.nc'],'ubar');
    model.ubar = ubar(:,1:hskip:end,1:hskip:end);
    clear ubar
    vbar = nc_varget(['./',model.file_prefix,'vbar_49_79.nc'],'vbar');
    ...
    times=roms_get_date(['./',model.file_prefix,'zeta_49_79.nc']);datestr(times(1:3))
