...
dstgrd = pycnal.grid.get_ROMS_grid('PALAU_800mHB')
...
for typ in type:
        ...
        grid2_file = 'remap_grid_PALAU_800mHB_'+str(typ)+'.nc'
        interp_file1 = 'remap_weights_PALAU_BrianFull_to_PALAU_800mHB_bilinear_'+str(typ)+'_to_'+str(typ)+'.nc'
        interp_file2 = 'remap_weights_PALAU_800mHB_to_PALAU_BrianFull_bilinear_'+str(typ)+'_to_'+str(typ)+'.nc'
        map1_name = 'PALAU_BrianFull to PALAU_800mHB Bilinear Mapping'
        map2_name = 'PALAU_800mHB to PALAU_BrianFull Bilinear Mapping'
        num_maps = 1
        map_method = 'bilinear'
