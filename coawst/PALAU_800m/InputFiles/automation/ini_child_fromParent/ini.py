...
src_filename = '../ini/HIS0_PALAU_800m.nc'
wts_file = "./remap_weights_PALAU_800m_to_PALAU_800m_child_bilinear_*"
src_grd = pycnal.grid.get_ROMS_grid('PALAU_800m')
dst_grd = pycnal.grid.get_ROMS_grid('PALAU_800m_child')
