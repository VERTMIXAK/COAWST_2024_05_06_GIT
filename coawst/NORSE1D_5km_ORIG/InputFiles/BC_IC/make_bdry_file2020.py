...
data_dir = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/NorthSea_2021/data_PHY/'
...
dst_grd = pycnal.grid.get_ROMS_grid('NORSE1D_2km')
...
for file in lst_file:
    ...
    dst_grd = pycnal.grid.get_ROMS_grid('NORSE1D_2km', zeta=zeta)
