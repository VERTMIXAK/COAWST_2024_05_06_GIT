...
#    time = time + 2.5 # 5-day average
    ...
    # get weights file
    wts_file = 'remap_weights_GLBa0.08_to_PRAIRIENest_3km_child_modified_bilinear_t_to_rho.nc'
    ...
    src_angle = pycnal.remapping.remap(src_grd.angle, \
           'remap_weights_GLBa0.08_to_PRAIRIENest_3km_child_modified_bilinear_t_to_rho.nc', \
                                           spval=spval)
