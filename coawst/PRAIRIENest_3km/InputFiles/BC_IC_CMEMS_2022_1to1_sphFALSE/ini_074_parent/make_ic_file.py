...
#file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/GUAM_2022/data_PHY/GLOBAL_ANALYSIS_FORECAST_PHY_001_024-TDS_2022_073.nc'
#file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/GUAM_2022/data_PHY/GLOBAL_ANALYSIS_FORECAST_PHY_001_024-TDS_2022_074.nc'
file = 'CMEMSsource_074_flat.nc'
dst_dir='./'
...
src_grd_file = '/import/c1/VERTMIX/jgpender/ROMS/CMEMS/GUAM_2021/GUAM_grid.nc'
...
dst_grd = pycnal.grid.get_ROMS_grid('PRAIRIE_3km_1to1_parent_sphFALSE')

# remap
print('about to do zeta')
zeta = remap(file, 'ssh', src_grd, dst_grd, dst_dir=dst_dir)
dst_grd = pycnal.grid.get_ROMS_grid('PRAIRIE_3km_1to1_parent_sphFALSE', zeta=zeta)
